...
export default function CategorieForm() {
    ...
    function handleSubmit(event:HTMLSU) {
        if (!categorie.id) {
            ...
            <div className="container">
                <div className="row">
                    <div className="col-md-6 offset-md-3 card py-2">
                        ...
                        <form onSubmit={handleSubmit} autoComplete="off" className="form-style">
                            <div className="mb-3">
                                <label htmlFor="libelle" className="form-label">Libelle de la categorie</label>
                                <input type="text" name='libelle' value={categorie.libelle} onChange={handleInputChange} className="form-control" id="libelle" aria-describedby="emailHelp" />
                            </div>
                            <div className="mb-3">
                                <label htmlFor="description" className="form-label">Description de la categorie</label>
                                <input type="text" name="descrition" value={categorie.descrition} onChange={handleInputChange} className="form-control" id="description" />
                            </div>
